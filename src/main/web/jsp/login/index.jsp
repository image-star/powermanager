		...
		<div class='login'>
			...
			<div class='login_fields'>
				<div class='login_fields__user'>
					...
					<input name="username" id="username" placeholder='请输入手机号码' maxlength="16"
						   value="13655442583" type='text' autocomplete="off"  />
				...
				<div class='login_fields__password'>
					...
					<input name="pwd" id="pwd"   placeholder='请输入密码' maxlength="16"
						  value="000000" type='password' autocomplete="off">
					<div class='validation'>
						<img alt="" src='<%=basePath%>static/login/img/tick.png' >
					</div>
				</div>
